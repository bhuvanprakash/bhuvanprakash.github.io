...
<div class="hero">
  ...
  <p class="hero-latest">Latest: <a href="{{ site.posts.first.url | relative_url }}">{{ site.posts.first.title }}</a></p>
  {% endif %}
</div>
...
<div class="home-cards">
  <section class="section home-card github">
    <h2 class="section-title">On GitHub</h2>
    <p class="section-lead">Repos I'm actively building.</p>
    <p><a href="{{ site.links.github }}" target="_blank" rel="noopener" class="deep-dive-link section-cta">View all →</a></p>
  </section>
  <section class="section home-card deep-dive">
    <h2 class="section-title">Deep Dive</h2>
    <p class="section-lead">Longer-form technical write-ups, format specs, and research.</p>
    <p><a href="{{ '/deep-dive/' | relative_url }}" class="deep-dive-link section-cta">View all deep dives →</a></p>
  </section>
  <section class="section home-card reading">
    <h2 class="section-title">What I'm reading</h2>
    <p class="section-lead">Books that shape how I build and think.</p>
    <p><a href="{{ '/reading/' | relative_url }}" class="deep-dive-link section-cta">View all books →</a></p>
  </section>
</div>
